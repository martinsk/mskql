-- tutorial: set operations - EXCEPT (set-operations.html)
-- setup:
...
-- input:
SELECT product_id, product_name FROM warehouse_east EXCEPT SELECT product_id, product_name FROM warehouse_west ORDER BY product_id;
-- expected output:
1|Widget A
4|Gadget Y
-- expected status: 0
